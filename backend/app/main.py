...
from app.api import mcp_bridge
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://partle.rubenayla.xyz", "http://localhost:3000", "http://localhost:5173", "http://192.168.1.117:3000", "https://chatgpt.com", "https://chat.openai.com"],
